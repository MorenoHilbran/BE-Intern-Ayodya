...
exports.registerUser = exports.loginUser = exports.authenticateUser = void 0;
...
var registerUser = exports.registerUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, email, phone, password, existingUser, hashedPassword, newUser;
...
var authenticateUser = exports.authenticateUser = function authenticateUser(req, res, next) {
  ...
  try {
    var verified = _jsonwebtoken["default"].verify(token.replace("Bearer ", ""), process.env.JWT_SECRET);
    req.user = verified;
    next();
  } catch (error) {
    res.status(400).json({
